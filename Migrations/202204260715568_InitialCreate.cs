    ...
    public partial class InitialCreate : DbMigration
    {
        public override void Up()
        {
            ...
            CreateTable(
                ...
                c => new
                    {
                        ...
                        RevokedDate = c.DateTime(),
                        TabNumber = c.String(),
                        Position = c.String(),
                        Department = c.String(),
                        Status = c.String(),
                        Photo = c.String(),
                        ElectronicsId = c.Guid(nullable: false),
                ...
                .PrimaryKey(t => t.Id)
                .ForeignKey("dbo.Electronics", t => t.ElectronicsId, cascadeDelete: true)
                .Index(t => t.ElectronicsId)
