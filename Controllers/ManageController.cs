...
namespace ManagementSystem.Controllers
{
    ...
    public class ManageController : Controller
    {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<ActionResult> EditProfile(EditProfileViewModel editProfileViewModel, HttpPostedFileBase Photo)
        {
            string lastimg = "";
            ...
            var user = await UserManager.FindByIdAsync(Misc.CurrentUser.Id);
            if (user == null)
            {
                return HttpNotFound();
            }
            user.UserName = editProfileViewModel.Email;
            ...
            user.MiddleName = editProfileViewModel.MiddleName;
            user.PhoneNumber = editProfileViewModel.PhoneNumber;
            lastimg = user.Photo;
            if (editProfileViewModel.BirthDate != null)
                user.BirthDate = editProfileViewModel.BirthDate;
